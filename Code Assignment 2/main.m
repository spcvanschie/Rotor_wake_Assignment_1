...
B_ind = induction_factors(normalvectors_upd,cp_coords_blade,vort_end_blade,TE_convected,eps,1);
[dL,C_L,dD_i,C_D_i,alpha_i,C_N,C_T] = aero_coefficients(rho,chord,surface_area,u_rotor_upd,circulation_blade,B_ind);
...
figure(2)
grid on
plot(cp_spanwise,circulation_history(:,1,timestep+1))
xlabel('Radial position [m]')
ylabel('Circulation [m2/s]')
