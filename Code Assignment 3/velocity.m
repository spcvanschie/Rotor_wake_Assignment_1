function [x_vel,x_vel_ind,z_vel,z_vel_ind] = velocity(x,z,plate_circulation,wake_circulation,vort_coords,wake_coords,V_inf,eps)
v_ind = [0;0];
...
x_vel = v_ind(1);
x_vel_ind = x_vel + V_inf(1);
z_vel = v_ind(2);
z_vel_ind = z_vel + V_inf(2);
end