function [r,R,B,mu_min,mu_local,twist,chordlength,chordangle,omega,blade_solidity]= geometry(N,pitch,lambda,U_inf,mu_min,twist_par,chordlength_par)
...
% ----------------------------------------------------------
twist = twist_par*(1-mu_local); % twist for each annulus [deg]
chordlength = chordlength_par*(1-mu_local)+1; % chord length for each annulus [m]
